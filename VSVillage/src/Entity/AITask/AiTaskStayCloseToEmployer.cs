...
public class AiTaskStayCloseToEmployer : AiTaskStayCloseToGuardedEntity
{
	...
	public AiTaskStayCloseToEmployer(EntityAgent entity, JsonObject taskConfig, JsonObject aiConfig)
		: base(entity, taskConfig, aiConfig)
	{
		employedForHours = aiConfig["employedForHours"].AsDouble(24.0);
	}

	public override bool ShouldExecute()
	{
		if (employedSince + employedForHours < entity.World.Calendar.TotalHours && employedSince > 0.0)
		{
