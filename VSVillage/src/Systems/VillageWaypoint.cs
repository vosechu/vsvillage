...
public class VillageWaypoint
{
	...
	public VillageWaypoint FindNearestReachableWaypoint(BlockPos pos)
	{
		...
		{
			if (villageWaypoint == null || key.Pos.ManhattanDistance(pos) < villageWaypoint.Pos.ManhattanDistance(pos))
			{
				villageWaypoint = key;
			}
		}
		...
		{
			if (villageWaypoint == null || key2.Pos.ManhattanDistance(pos) < villageWaypoint.Pos.ManhattanDistance(pos))
			{
